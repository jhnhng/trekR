...
For environmental covariates that vary across time (e.g., temperature, snow depth, foraging resources, precipitation, etc.), we first
assign the file names of which the covariates are housed to `list_names`. In our example, we use Rangeland Analysis Platform (RAP) data in 2013 and 2014 that can be an indicator of forage resources on the landscape. 
